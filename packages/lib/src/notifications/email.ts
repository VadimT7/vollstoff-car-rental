...
export async function sendEmail({
  to,
  template,
  replyTo = process.env.EMAIL_REPLY_TO || 'elitemotionrentals@gmail.com',
  attachments = [],
}: SendEmailParams): Promise<string> {
  const { data, error } = await resend.emails.send({
    from: process.env.EMAIL_FROM || 'elitemotionrentals@gmail.com',
...
function generateBookingConfirmationTemplate(booking: any): EmailTemplate {
  ...
  const subject = `Booking Confirmation - ${booking.car.displayName} | Elite Motion Rentals`
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>
            Thank you for choosing Elite Motion Rentals. Your booking for the 
          ...
          <p>
            ...
            <a href="mailto:elitemotionrentals@gmail.com">elitemotionrentals@gmail.com</a> 
            or call us at +1 (438) 680-3936.
          </p>
        </div>
        
        <div class="footer">
          <p>© ${new Date().getFullYear()} Elite Motion Rentals. All rights reserved.</p>
          <p>
  ...
  const text = `
Elite Motion Rentals - Booking Confirmation

Dear ${booking.user?.name || booking.guestName || 'Valued Customer'},

Thank you for choosing Elite Motion Rentals. Your booking for the ${booking.car.displayName} has been confirmed.
...
Pickup Location: ${booking.pickupType === 'DELIVERY' ? 'Delivery to your location' : 'Elite Motion Rentals Showroom'}
...
If you have any questions or need to make changes to your booking, please contact us at elitemotionrentals@gmail.com or call +1 (438) 680-3936.

© ${new Date().getFullYear()} Elite Motion Rentals. All rights reserved.
  `.trim()
...
function generatePickupReminderTemplate(booking: any): EmailTemplate {
  ...
  const subject = `Pickup Reminder - ${booking.car.displayName} Tomorrow | Elite Motion Rentals`
  ...
  const html = `
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #1a1a1a; margin: 0; padding: 20px;">
      <div style="max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #f9f9f9; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Location:</strong> ${
            booking.pickupType === 'DELIVERY' 
              ...
              : 'Elite Motion Rentals Showroom, 123 Luxury Avenue, Monaco'
          }</p>
        </div>
        ...
        <p>Best regards,<br>The Elite Motion Rentals Team</p>
      </div>
    </body>
    </html>
  `
